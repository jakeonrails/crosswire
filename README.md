...
> **Status: alpha.** Thirty primitives of a planned 39, plus a separate
...
`disclosure` · `dialog` · `confirm` · `tabs` · `popover` · `menu` · `combobox`
...
9 more are specified in `research/notes/08-ui-pattern-catalog.md` — the vocabulary was
